...
import ViewPost from "../../ViewPost/ViewPost";
  ...
  const UpdateJobPost = ({
    ...
    const onSubmit = (data) => {
      ...
      navigate("/job-updation/assign-job-post");
    };
    ...
    <Grid container  >
        ...
        >
          <Grid item md={12} display={"flex"} justifyContent={"space-between"} sx={{p:{xs : 1 , sm  :1.5 , md : 2 , lg : 2.5 , xl : 3}}} >
            <Typography variant="h4"  sx={{ fontSize : { xs : "1rem" , md : "1.4rem" ,lg : "1.7rem" , xl : "2rem" } }}   fontWeight={700}>
              Edit Job Post
            </Typography>
            {/* <Button variant="outlined" onClick={()=>navigate("/Jobpost/create-template")} >Create Template</Button> */}
          </Grid>
          <Grid item xs={12}>
            <Typography variant="h6" bgcolor={"secondary.light"} sx={{ py:{xs : 1 , lg : 1.5 , xl : 2} , px : {xs : 1 , sm  :1.5 , md : 2 , lg : 2.5 , xl : 3} , fontSize : {xs : ".8rem" , md : "1rem" ,lg : "1.5rem" ,xl :"1.5rem" } }}>
              Job Title
            </Typography>
          </Grid>
          <Grid
        ...
        >
          <Grid item container position={"fixed"}>
            <Grid item container>
              ...
              <Grid item container>
                {drafts.filter((draft,index) => index <2).map( draft  => (
    ...
    {draft && <ViewPost jobPostingData={draft} recruiters={recruiters} draft={true} /> }
